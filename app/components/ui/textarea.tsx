...
const textareaVariants = cva(
  "bg-background ring-offset-background text-text-dim placeholder:text-text-dim rounded-md focus-visible:ring-ring flex min-h-[80px] w-full text-sm focus-visible:outline-none  disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "border border-thin-gray placeholder-gray focus-visible:ring-2 focus-visible:ring-offset-2",
        noBorderAndFocus:
        ...
        noFocus:
          "border border-thin-gray placeholder-gray focus-visible:ring-0 focus-visible:ring-offset-0",
        minimal:
      ...
      size: {
        ...
        lg: "px-5 pl-2 py-6 pt-2 text-lg",
      },
    },
    defaultVariants: {
      variant: "default",
