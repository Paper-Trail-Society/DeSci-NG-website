...
const TwitterSvg = () => {
  return (
    <svg
      ...
      stroke="currentColor"
      strokeWidth="2"
      className="transition-all duration-300 group-hover:fill-current group-hover:text-primary"
...
const TikTokSvg = () => {
  return (
    ...
    >
      <title>TikTok</title>
      <path d="M9.5 2v14.5a3.5 3.5 0 1 1-3.5-3.5" />
      <path d="M14.5 2c0 3.5 2.5 5 5 5v3.5a7.5 7.5 0 1 1-7.5-7.5" />
    </svg>
  );
};
