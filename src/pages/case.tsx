...
const Case = () => {
  return (
    <>
      <Header />
      <div className="pt-[20px] px-[20px] pb-0 max-w-[800px] mx-auto my-0 lg:max-w-[1000px]">
        <h1 className="text-[2.2rem] lg:text-[2rem] md:text-[1.5rem] mb-5 text-primary-red">
          A Case for Decentralized Science.
        </h1>
        <p className="leading-[1.6] mb-[15px]">
